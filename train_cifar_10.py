...
def initialise_transforms(args):
    ...
    # Convert to grayscale (as in paper)
    ...
    # Do not use proper normalisation if color but it's OK it's CIFAR-10.
...
def train_models() -> None:
    ...
    transform = initialise_transforms(args)

    trainset = NatCIFAR10(root=args.data_dir,
                          train=True,
